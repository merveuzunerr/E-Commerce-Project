...
namespace Repository.Migrations
{
    ...
    [Migration("20231004204812_BaseEntity")]
            ...
            modelBuilder.Entity("Core.Models.ProductFeature", b =>
                {
                    ...
                    b.ToTable("Products Features Table", (string)null);
            ...
            modelBuilder.Entity("Core.Models.SubCategory", b =>
                {
                    ...
                    b.ToTable("Sub Categories Table", (string)null);
            ...
            modelBuilder.Entity("Core.Models.Product", b =>
                {
                    b.HasOne("Core.Models.Basket", "Basket")
                        .WithOne("Product")
                        .HasForeignKey("Core.Models.Product", "BasketId");
            ...
            modelBuilder.Entity("Core.Models.UserAccount", b =>
                {
                    b.HasOne("Core.Models.Basket", "Basket")
                        .WithOne("UserAccount")
                        .HasForeignKey("Core.Models.UserAccount", "BasketId");
