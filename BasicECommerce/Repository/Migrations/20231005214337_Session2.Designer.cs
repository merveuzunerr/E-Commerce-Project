...
namespace Repository.Migrations
{
    ...
    [Migration("20231005214337_Session2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.GuestAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Models.GuestAccount", b =>
                {
                    b.HasOne("Core.Models.Cart", "Cart")
                        .WithOne("GuestAccount")
                        .HasForeignKey("Core.Models.GuestAccount", "CartId");
            ...
            modelBuilder.Entity("Core.Models.Session", b =>
                {
                    b.HasOne("Core.Models.GuestAccount", "GuestAccount")
                        .WithOne("Session")
                        .HasForeignKey("Core.Models.Session", "GuestAccountId");
            ...
            modelBuilder.Entity("Core.Models.UserAccount", b =>
                {
                    ...
                    b.HasOne("Core.Models.Session", "Session")
                        .WithOne("UserAccount")
                        .HasForeignKey("Core.Models.UserAccount", "SessionId");
